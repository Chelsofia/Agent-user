  ...
  return (
    <>
      <AppWrapper title="Dashboard">
        <div className="min-h-screen mt-4 p-8 ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
            <div className="bg-primary text-white p-4 rounded-md">
              ...
              <Link
                ...
                className="flex items-center mt-2 text-secondary hover:underline text-sm"
              >
                View Referrals <FaArrowRight className="ml-2" />
              </Link>
            </div>

            <div className="bg-[#035A2B] text-white p-4 rounded-md">
